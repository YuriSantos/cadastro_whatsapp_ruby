class ApplicationController < ActionController::Base
  ...
  rescue_from JfpbException::SecurityTransgressionException, with: :permission_denied
  ...
  private
    def require_role(role_name)
      raise JfpbException::SecurityTransgressionException unless current_user.has_role?(role_name)
    end
